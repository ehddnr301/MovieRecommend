...
class RecommendService:
    def __init__(self, movie_repository: MovieRepository, model_repository: ModelRepository) -> None:
    ...
    def get_model_recommendations(self, user_id: int):
        return self._model_repository.create_prediction(user_id)